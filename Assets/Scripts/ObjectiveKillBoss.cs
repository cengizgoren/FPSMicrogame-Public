...
public class ObjectiveKillBoss : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<Objective, ObjectiveKillBoss>(m_Objective, this, gameObject);

        m_EnemyManager = FindObjectOfType<EnemyManager>();
        DebugUtility.HandleErrorIfNullFindObject<EnemyManager, ObjectiveKillBoss>(m_EnemyManager, this);
