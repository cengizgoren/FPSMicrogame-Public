...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<PlayerWeaponsManager, 
            PlayerCharacterController>(m_WeaponsManager, this, gameObject);
    ...
    void GroundCheck()
    {
        ...
        {
            // if we're grounded, collect info about the ground normal with a downward 
            //capsule cast representing our character capsule
                ...
                groundCheckLayers, QueryTriggerInteraction.Ignore))
            {
                ...
                // Only consider this a valid ground hit if the ground normal goes 
                //in the same direction as the character up
    ...
    void HandleCharacterMovement()
    {
        // horizontal character rotation
        {
            ...
            transform.Rotate(new Vector3(0f, (m_InputHandler.GetLookInputsHorizontal() * 
    ...
    // Returns true if the slope angle represented by the given normal is under the 
    //slope angle limit of the character controller
